...
const CTASection = () => {
  return (
    <section className="py-20 lg:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-cyan-500/10 to-transparent relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
            <span className="block text-white mb-3">Ready to Visualize?</span>
          ...
          {/* Social Proof */}
          <motion.div
            className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-center items-center gap-8"
            initial={{ opacity: 0 }}
